...
prevented it: on macOS 26.4 through 26.6, Metal workloads can panic the kernel inside Apple's IOGPU
...
not using the GPU. No userland supervisor reaches it. The [compatibility matrix](COMPATIBILITY.md)
