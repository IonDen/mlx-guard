...
| [Tutorial](https://github.com/IonDen/mlx-guard/blob/main/TUTORIAL.md) | One real summarizer job, unguarded by arithmetic and guarded by recording: observe, limit, checkpoint, resume, fix |
