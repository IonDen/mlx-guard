...
The [M1 Max 32 GB reference bundle](evidence/v0.1.0/m1-max-32gb/README.md) contains the raw v0.1
accuracy, timing, endurance, lifecycle, and false-intervention measurements.
